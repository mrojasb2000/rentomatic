...
def test_respository_list_without_params(app_configuration, pg_session, pg_test_data):
...
def test_repository_list_with_price_greater_than_filter(app_configuration, pg_session, pg_test_data):
    repo = postgresrepo.PostgresRepo(app_configuration)
